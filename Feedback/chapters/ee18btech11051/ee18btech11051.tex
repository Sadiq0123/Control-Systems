...
\end{align}
Also, as we already know from eq.\ref{eq:ee18btech11051_7} that $(\omega RC)^{2} = 6$, the oscillator frequency ($2\pi f = \omega$) can be set to 10kHz by varying the capacitor value.
\begin{align}
